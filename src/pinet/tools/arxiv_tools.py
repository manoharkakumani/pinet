...
Usage:
from pinet.tools import arxiv_tools
papers = arxiv_tools.search("quantum computing")
paper = arxiv_tools.get_paper("2401.00123")

or
from pinet.tools import search_arxiv, get_arxiv_paper
...
__tools__ = [
    ...
    },
    {
        ...
        "description": "Get details of a specific paper by its arXiv ID",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Get papers from a specific category",
        "parameters": {
            "type": "object",
            "properties": {
